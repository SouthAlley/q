...
// 暂时 third_party_fileX('link',css_common.gehr
// third_party_fileX("script",js_common.crisp
// 油猴用户（桌面浏览器用户）可通过 // 注释上述代码来禁用Crisp；
// Qx/Shadrowrocket/Surge/Loon 等代理软件用户可通过添加分流来禁用Crisp；（分流类型选择 DOMAIN-KEYWORD,crisp
...
var imax = {
    ...
    css: {
        ...
        libvio: ".container > .t-img-box:first-child,.hidden-log 
        goole: "#tvcap,[data-text-ad] {display:none !important}"
        avple: "#adsbox,.asg-overlay
        btbdys: ".artplayer-plugin-ads,.artplayer-plugin-ads
        switch: ".switch {display:none !important}",
        ddrk: "#fkasjgf {display: none !important}",
        jable: "body {overflow-x:hidden# } div.site-content {overflow-x:hidden!important# } div.text-center > a[target=_blank],li[class*='nav-item'] >  a[target=_blank]
        test: "*,div
        tvn: "img[src*='gif'],iframe {display:none !important#  pointer-events:none important# }"
        comic_18: "div.div2_sticky2,p > a[target=_blank]
        dy555: "div.module {z-index:1!important} div.popup.popup-tips.none.popupShow,a[target=\"_blank\"] img
        wnacg: "div > img[src*='gif'],div.sh
        missav: "a[href*='bit.ly'][target=_blank],a[href*='/vip']
        porn91: "br,.ad_img
        zhihuAds: "div.css-1izy64v,[class='Card AppBanner']
        pornhubx: ".topAdContainter,a[href*='ads']
        instagram: "div._aagw {display:none !important}",// 网页版Instagram不能复制图片的问题
        ttsp: "div#playad1,a[href*=\"8616.tech\"]
        tz659: "figure,img[src*='mt2.jpg']
        anime: "div[id*=ad] {display:none !important}",
        yhdmp: ".yrtjbmnk_b,.hvitsutz_b {display :none !important#  pointer-events: none !important# }"
        //nivod: "[style='text-align: center#  margin-top: 30px# '],iframe
        nivod: "img[src*='1a732eeb1adb'],img[src*='49e8abd32d13']
        _91short: "a[href*=lhiefl],a[href*=lol]
        xiaobaotv: "",
...
function adsDomain_switch(x) { // 匹配参数值 执行相应函数
    switch (x) {
        case 'pornhub':
            ...
            css_adsRemove(imax.css.pornhubx,500

            setTimeout(() => {
                let ads_selector = [".topAdContainter","a[href*='ads']"
                let ads = setInterval(() => {
            ...
            setTimeout(() => {
                ele_dynamicAppend("div.ratingInfo,div.categoryRow.ratingDetails.sectionPadding"
            ...
            setTimeout(() => {
                if (ua_missav.indexOf(mobile_missav) === -1) {
                    ...
                    if (document.querySelector('div.mt-4').querySelector('h1') !== null) {
                        ele_dynamicAppend("div.mt-4","onclick"
                        ele_dynamicAppend("div.mt-4","onclick"
                        ele_dynamicAppend("div.mt-4","href"
                    }
                    ...
                    if (document.getElementById("missavX")) {
                        addListenerById("missavX",() => { video_loopPlay('loop') }
                    }

                    if (document.getElementById("missavP")) {
                        addListenerById("missavP",() => { video_loopPlay('pause') }
                    }
        ...
        case 'avple':
            ...
            third_party_fileX("script",imax.js.avple
            break# 
        case '18comic':
        ...
        case "555dyx":
            ...
            css_adsRemove(imax.css.dy555,0
        ...
        case 'ddys':
            ...
            selector_adsRemove("#sajdhfbjwhe,#kasjbgih
            break# 
        case 'duboku':
            third_party_fileX("script",imax.js.duboku
            break# 
        case 'libvio':
        ...
        case 'jable': // 2333
            ...
            if (/\b(.*\.)(jable\.tv.*)\b/i.test(window.location.href.toLowerCase())) {
                ...
                let url_jable_rewrite = window.location.href.toLowerCase().replace(/https:\/\/\w{2,3}\./i
            ...
            if (url_jable.search(reg_videos) !== -1) {
                setTimeout(() => {
                    ele_dynamicAppend("div.header-left > h6","onclick"
                    ele_dynamicAppend("div.header-left > h6","onclick"
                    ele_dynamicAppend("div.header-left > h6","onclick"
                    // 添加监听器
                    addListenerById("jablex",() => { copyText("copy"
                },3000)
        ...
        case 'bdys':
            ...
            css_adsRemove(imax.css.switch,0
            ...
            if (url == "https://www.bdys10.com/" || url == "https://www.bdys03.com/") {
                if (!document.getElementById("bdys")) {
                    ele_dynamicAppend("div.container-xl","onclick"
        ...
        case 'javday':
            // nothing to do.
            css_adsRemove(imax.css.javday,0
            break# 
        case 'xvideos':
            setInterval(() => {
                if (!document.getElementById('xvideos_t')) {
                    css_adsRemove(imax.css.xvideos,100
                    noWindowOpenIf()# 
                } else {
                    noWindowOpenIf()# 
                }
        ...
        case 'javbus':
            css_adsRemove(imax.css.javbus,0
            break# 
        case "4hu":
            css_adsRemove(imax.css._4hu,0
            hrefAttribute_set()# 
            break# 
        case "netflav":
            window_open_defuser()#  // 打断 window.open 施法
            css_adsRemove(imax.css.netflav,0
            break# 
        case "filemoon":
            window_open_defuser()#  // 打断 window.open 施法
            break# 
        ...
        case "supjav":
            ...
            css_adsRemove(imax.css.supjav,0
            break# 
        case "njav":
            css_adsRemove(imax.css.njav,0
            break# 
        case "hanime1":
        ...
        case "javlibrary":
            ...
            function javlibrary() {
                // '#topmenu','div.menutext'
                css_adsRemove(imax.css.javlibrary)# 
                var target_ = ['#rightcolumn','.videothumblist'
            ...
            function xqy() {
                setTimeout(() => { // 番号详情页添加番号搜索等操作
                    ...
                    if (document.querySelector('tr td.text')) {
                        ...
                        ele_dynamicAppend("#video_id > table > tbody","onclick"
                        ele_dynamicAppend("#video_id > table > tbody","target"
                        ele_dynamicAppend("#video_id > table > tbody","onclick"
                        document.getElementById('copy').value = code# 
                        document.getElementById('javlibraryx').addEventListener('click',() => {
                            copyText("copy","javlibraryx"
                        })
        ...
        case 'zhihu':
            ...
            css_adsRemove(imax.css.zhihuAds,100
            indexLogin()# 
        ...
        case 'twitter':
            ...
            break# 
        case 'olevod':
            css_adsRemove(imax.css.olevod,0
            setTimeout(() => {
                onAdsHide()
            },500)
            break# 
    ...
    if (csp_regex.test(window.location.href.toLowerCase()) && !(/\b(mobile)\b/i.test(navigator.userAgent.toLowerCase()))) {
        ...
        let daohang = setInterval(() => {
            if (!((document.querySelector("button#x4Home")) && (document.querySelector("script[src*='Adblock4limbo.function.js']")))) {
                third_party_fileX("script",imax.js.functionx
...
function jable_adsRemove() { // Cookie 设定及注入
    ...
    const div = document.querySelectorAll("div.col-6.col-sm-4.col-lg-3,div.col-6.col-sm-4.col-xl-3
...
function ele_dynamicAppend(selector,attribute
...
function addListener(selector,funx) {
    setTimeout(() => {
        ...
        for (let index = 0#  index < ele.length#  index++) {
            ele[index].addEventListener("click",funx
        }
    },1000)
}
...
function addListenerById(id,funx
    setTimeout(() => {
        ...
        eleById.addEventListener("click",funx
    },time)
}
...
function href_attributeSet(time,id) {
    ...
    setTimeout(() => {
        ...
        if (ele_button.length > 0) {
            window.onload = addListener(selector,() => { href_attributeSet(time
        }
        let times = 0# 
...
function third_party_fileX(tagname,url
...
function css_adsRemove(newstyle,delaytime
    setTimeout(() => {
...
function videoAds_accelerateSkip(fasterx) {
    ...
    boost = isNaN(boost) === false && isFinite(boost)
        ? Math.min(Math.max(boost,fasterx)
        : fasterx# 
...
function m3u8_tempt(x) {
    var i,url_result#  var url_regex = new RegExp(x
    var ele = ["script","a"]# 
    var ele_catch = document.querySelectorAll(ele)# 
...
function notice_hidden(selector) { // bdys
    ...
    addListenerById("bdys",() => { notice_show("div.col-12") }
}
...
function window_open_defuser() {
    ...
    const createDecoy = function (tag,urlProp
        const decoy = document.createElement(tag)# 
        decoy[urlProp] = url# 
        decoy.style.setProperty('height','1px'
        decoy.style.setProperty('position','fixed'
        decoy.style.setProperty('top','-1px'
        decoy.style.setProperty('width','1px'
    ...
    window.open = new Proxy(window.open,{
        apply: function (target,thisArg
            ...
            const decoy = /\bobj\b/.test(arg3)
                ? createDecoy('object','data'
                : createDecoy('iframe','src'
            ...
            if (/\blog\b/.test(arg3)) {
                popup = new Proxy(popup,{
                    get: function (target,prop) {
                        log('window.open / get',prop
                        return Reflect.get(...arguments)# 
                    },
                    set: function (target,prop
                        log('window.open / set',prop
                        return Reflect.set(...arguments)# 
                    },
                })# 
            }
...
function setConstant(
    ...
    const trapProp = function (owner,prop
...
function evaldataPrune() {
    window.eval = new Proxy(eval,{
        apply: (a,b
            if (c[0] && c[0].includes("commercial") && c[0].startsWith("(") && c[0].endsWith(")")) { let a = c[0].slice(1).slice(0,-1)
            return Reflect.apply(a,b
        }
    })
}# 
...
function noWindowOpenIf(
    ...
    const createDecoy = function (tag,urlProp
        ...
        decoyElem.style.setProperty('height','1px'
        decoyElem.style.setProperty('position','fixed'
        decoyElem.style.setProperty('top','-1px'
        decoyElem.style.setProperty('width','1px'
    ...
    window.open = new Proxy(window.open,{
        apply: function (target,thisArg
            ...
            if (logLevel) {
                popup = new Proxy(popup,{
                    get: function (target,prop) {
                        safe.uboLog('window.open / get',prop
                        return Reflect.get(...arguments)# 
                    },
                    set: function (target,prop
                        safe.uboLog('window.open / set',prop
                        return Reflect.set(...arguments)# 
                    },
                })# 
            }
